          ...
          <div className="prose prose-lg max-w-none space-y-8 text-gray-700">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-4">
                ...
                <li><strong>Plus:</strong> Paid monthly or annually. Priced at ₹399/month plus applicable GST, or ₹3,830/year plus GST (India), and $5/month or $48/year (international, no GST). Covers a single clinic location and up to 5 staff logins, subject to limits of 300 new patient records and 300 appointments per calendar month, and includes patient records, dental charting, treatment planning, prescriptions, appointments and online booking, billing, consent forms, inventory, own-number WhatsApp messaging, the report library with 12 months of history, and the web, mobile and desktop applications.</li>
