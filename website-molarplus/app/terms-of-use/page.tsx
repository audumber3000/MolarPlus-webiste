          ...
          <div className="prose prose-lg max-w-none space-y-8 text-gray-700">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-4">
                ...
                <li><strong>Plus:</strong> Paid monthly or annually. Priced at ₹399/month plus applicable GST, or ₹3,830/year plus GST (India), and $5/month or $48/year (international, no GST). Covers one clinic location and up to 5 staff logins, subject to limits of 500 new patient records and 500 appointments per calendar month and 100 GB of document and image storage. Includes patient records, dental charting, treatment planning, prescriptions, appointments and online booking, billing, consent forms, inventory, audit logging, Google review management, the report library with 12 months of history, and the web, mobile and desktop applications. WhatsApp and email notifications are sent from a verified MolarPlus sender.</li>
                <li><strong>Pro:</strong> Paid monthly or annually. Priced at ₹999/month plus applicable GST, or ₹9,590/year plus GST (India), and $10/month or $96/year (international, no GST). Covers up to 5 clinic locations and up to 10 staff logins, subject to limits of 1,000 new patient records and 1,000 appointments per calendar month and 150 GB of storage. Includes everything in Plus, adding messaging from the clinic&apos;s own WhatsApp number, granular per-user permissions, the unified email and WhatsApp inbox, local competitor tracking, a clinic website, unlimited report history with bulk data export, and priority support.</li>
                <li><strong>Growth:</strong> Paid monthly or annually. Priced at ₹1,500/month plus applicable GST, or ₹14,400/year plus GST (India), and $15/month or $144/year (international, no GST). Includes everything in Pro with no usage ceilings — unlimited clinic branches under one account, unlimited staff logins, patient records, appointments and storage — and adds cross-branch consolidated reporting, and assisted onboarding and data migration with a named support contact.</li>
              </ul>
              <p className="mt-4">
