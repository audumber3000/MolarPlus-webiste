...
export const FAQ: ReadonlyArray<FaqItem> = [
  ...
  },
  {
    ...
    a: "Yes. Send us whatever you have, whether that is an Excel sheet, a backup from your current software or a printed stock list, and we will import it for you before you start. There is no charge for this and you do not have to type it in yourself.",
  },
  {
